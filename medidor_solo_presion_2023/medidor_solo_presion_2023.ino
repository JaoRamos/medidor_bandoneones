...
const int CONTAR_HASTA = 3;   // f = 300 / CONTAR_HASTA
...
void enviar_valores() {
  ...
  //Serial.print(SEP);  
  Serial.println((presionAtmosferica + offset_presion));
  //Serial.print(SEP);
...
void enviar_encabezados(){
  ...
  //Serial.print(SEP);  
  (usando_calibracion) ? Serial.println("PExterna_Calibrada") : Serial.println("PExterna_Cruda");
  //Serial.print(SEP);
